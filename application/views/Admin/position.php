...
<section class="sub-bnr" data-stellar-background-ratio="0.5" >
    <div class="position-center-center">
        <div class="container">
            <h4>सदस्यता पदों की लिस्ट Positions list</h4>
        </div>
    </div>
</section>
...
<div id="content" class="content">
    ...
    <div class="panel panel-inverse">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group ">
                            <label for="exampleInputEmail1" class="col-form-label">पद का नाम </label>
                            <div class="">
                                <input type="text" class="form-control"  placeholder="Enter Position Name" value="" required="" name="position_name">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
        ...
        <div class="table-responsive">
            <table class="table">
                <tr>
                    <th style="width:200px;">पद का नाम </th>
                ...
                foreach ($positiondata as $key => $value) {
                    ...
                    <tr>
                        <td>
                            <span  id="name<?php echo $value['id']; ?>" data-type="text" data-pk="<?php echo $value['id']; ?>" data-name="position_name" data-value="<?php echo $value['position_name']; ?>" data-params ={'tablename':'category_position'} data-url="<?php echo site_url("Api/updateCurd"); ?>" data-mode="inline" class="m-l-5 editable editable-click" > <?php echo $value['position_name']; ?></span>
                        </td>
